...
import { Alert_Shadcn, AlertDescription_Shadcn, AlertTitle_Shadcn } from '@ui';
...
export interface AdmonitionProps {
  ...
  showIcon?: boolean;
  childProps?: {
    title?: React.ComponentProps<typeof AlertTitle_Shadcn>;
    description?: React.ComponentProps<typeof AlertDescription_Shadcn>;
  };
}
...
export const Admonition = forwardRef<
  React.ElementRef<typeof Alert_Shadcn>,
  React.ComponentPropsWithoutRef<typeof Alert_Shadcn> & AdmonitionProps
>(
  (
      ...
      <Alert_Shadcn
        ...
        {label || title ? (
          <>
            ...
            {description && (
              <AlertDescription_Shadcn className={props.childProps?.description?.className}>
                {description}
