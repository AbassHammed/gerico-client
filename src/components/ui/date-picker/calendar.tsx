...
import { ElementType, forwardRef, HTMLAttributes, useRef } from 'react';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: 'rounded aria-selected:bg-blue-500 aria-selected:text-white',
        day_disabled: '!text-gray-300 line-through disabled:hover:bg-transparent',
        day_outside: 'text-gray-400',
        day_range_middle: '!rounded-none aria-selected:!bg-blue-100 aria-selected:!text-blue-900',
