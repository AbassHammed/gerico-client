...
const ScaffoldHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <header
      {...props}
      ref={ref}
      className={cn('w-full', 'flex-col gap-3 py-6', className)}></header>
  ),
);
...
>(({ className, ...props }, ref) => (
  <h1 ref={ref} {...props} className={cn('text-2xl', className)} />
));
...
const ScaffoldDescription = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLHeadingElement>
>(({ className, ...props }, ref) => (
  <span ref={ref} {...props} className={cn('text-sm text-foreground-light', className)} />
));
...
const ScaffoldActionsContainer = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} {...props} className={cn('flex w-full items-center', className)} />
));

// Actions Group
const ScaffoldActionsGroup = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} {...props} className={cn('flex flex-row gap-3', className)} />
  ),
);
