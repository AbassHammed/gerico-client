...
import { SidebarInset, SidebarProvider, SidebarTrigger } from '@/components/ui/shadcn/ui/sidebar';
        ...
        <header className="sticky top-0 flex h-14 shrink-0 items-center gap-2 bg-sidebar border border-sidebar-border">
          <div className="flex flex-1 items-center gap-2 px-3">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
                  <BreadcrumbPage className="line-clamp-1">Create an employee</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
